...
using Azimuth.AuthProviders.Vkontakte.Provider;
...
namespace Azimuth.AuthProviders.Vkontakte
{
    public class VkAuthenticationHandler : AuthenticationHandler<VkAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new VkAuthenticatedContext(Context, user, accessToken, expires)
                {
